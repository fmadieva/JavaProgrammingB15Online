...
public class ArrayListPractice_ShortWay {
    public static void main(String[] args) {
        ...
        //prices.add(12.8); - does not compile
        //prices.remove(0); - does not compile.. You cannot add or remove

        // how to see how many are more than 5?
        // do each loop to see each and every item
        ...
        newPrices.remove(0.99); // remove method will remove only the first occurrence of the value
