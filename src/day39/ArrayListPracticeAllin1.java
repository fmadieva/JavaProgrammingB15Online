...
public class ArrayListPracticeAllin1 {
...
//         * Task 2 : print all the prices more than 500
        for (String eachProduct : productLst) {
            ...
            double price = Double.parseDouble(eachProduct.split(",")[1]); // make string to double price using Double.parseDouble
...
//         * Task 3 : print average price
        ...
        for (String eachProduct : productLst) {
            ...
            double price = Double.parseDouble(eachProduct.split(",")[1]); // double is method, parseDouble is method from that class
...
//         *  itemNames(String), prices(Double) , monthlyPayments(Double)  :
        ...
        for (String eachProduct : productLst ) {
            ...
            //String eachProduct = "iPhone 6s,449,18.71"; // do it for one, then put it in each loop and do it for all
