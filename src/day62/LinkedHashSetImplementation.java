...
// use HashSet instead of LinkedHahSet
// HashSet is faster because it does not keep order so it has less job to do, does not deal with keeping the
// insertion order


//List has index
// any set no index ( all about removing duplicate
