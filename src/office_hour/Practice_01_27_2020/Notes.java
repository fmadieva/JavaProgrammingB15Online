...
public class Notes {
     /*
    01/27/2020
SimpleCalculator Topics: 1. final keyword
...
final keyword: constant,  immutable
		only applicable:
			...
			2. methods: the implementation/functionality can not changed. (cannot be overridden)
			3. class (none abstract): immutable class
					cannot be super class ( cannot be inherited)
					but can be sub class
object instances: constructor, instance variables, instance methods
...
this() & super() rules:
				...
				2. constructor cannot be called by their names
...
constructor rules:
		1. constructor cannot be overridden, but can be overloaded
