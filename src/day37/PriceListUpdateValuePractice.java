...
public class PriceListUpdateValuePractice {
    ...
    public static void main(String[] args) {
        ...
        // add 4 dollars to first price : your first price value should be original price +4
...
//        priceList.set(0 , newValue ) ;
        ...
        priceList.set(lastIndex, temp); // assign the first value to the last index
